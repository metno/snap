/*
  ...
  $Id: diContouring.h,v 2.1 2006/05/29 09:53:51 ansteinf Exp $
...
void fillContours(vector<ContourLine*>& contourlines,
		  ...
		  const PlotOptions& poptions, bool drawBorders, GLPfile* psoutput,
		  const Area& fieldArea, float zrange[], float zstep, float zoff);
