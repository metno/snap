/*
  ...
  $Id: diFontManager.cc,v 2.0 2006/05/24 14:06:27 audunc Exp $
...
//#####################################################################
//fontpath= "/home/anstein/local/src/diana/fonts";
  fontpath= "/usr/local/share/diana/fonts";

  sect_fonts.push_back("font=Helvetica type=bitmap name=*-helvetica-medium-r*iso8859-1 postscript=Helvetica");
  sect_fonts.push_back("font=Helvetica type=bitmap name=*-helvetica-bold-r*iso8859-1   postscript=Helvetica-Bold");
  sect_fonts.push_back("font=Helvetica type=bitmap name=*-helvetica-medium-o*iso8859-1 postscript=Helvetica-Oblique");
  sect_fonts.push_back("font=Helvetica type=bitmap name=*-helvetica-bold-o*iso8859-1   postscript=Helvetica-BoldOblique");

  sect_fonts.push_back("font=Arial  type=scaleable face=NORMAL name=Arialn.ttf");
  sect_fonts.push_back("font=Arial  type=scaleable face=ITALIC name=Arialni.ttf");
  sect_fonts.push_back("font=Arial  type=scaleable face=BOLD   name=Arialnb.ttf");

  sect_fonts.push_back("BITMAPFONT=Helvetica");
  sect_fonts.push_back("SCALEFONT=Arial");
//#####################################################################
  ...
  for (int i=0; i<n; i++){
    ...
    for (int j=0; j<stokens.size(); j++){
      vector<miString> keyval= stokens[j].split('=');
      miString key= keyval[0];
      miString val= keyval[1];
