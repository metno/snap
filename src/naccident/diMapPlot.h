/*
  ...
  $Id: diMapPlot.h,v 2.0 2006/05/24 14:06:23 audunc Exp $
...
private:
  ...
  bool pland4(const miString&, int, float[], float[],
	      const Linetype&, float, const Colour&);
  bool geoGrid(float latitudeStep, float longitudeStep,
               int plotResolution= 10);
